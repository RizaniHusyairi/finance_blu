@extends('layouts.app')
@section('title', 'Verifikasi NPI Kontrak — Kasubbag')

@section('content')
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
    <div>
        <h5 class="fw-bold text-primary mb-0">Verifikasi NPI</h5>
        <p class="text-muted mb-0">Kontrak — Kepala Subbagian Keuangan dan Tata Usaha</p>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body py-3">
        <form method="GET" action="{{ route('verifikasi-kasubag.npi.kontrak.index') }}" class="row g-2 align-items-end">
            <div class="col-md-2">
                <label class="form-label small fw-semibold mb-1">Status Saya (Kasubbag)</label>
            ...
            <div class="col-md-2">
                <label class="form-label small fw-semibold mb-1">Status BenPen</label>
            ...
            <div class="col-md-2 d-flex gap-1">
                ...
                <a href="{{ route('verifikasi-kasubag.npi.kontrak.index') }}" class="btn btn-outline-secondary btn-sm"><i class="material-icons-outlined" style="font-size:16px; vertical-align: middle;">refresh</i></a>
            </div>
        </form>
    </div>
</div>
                ...
                <tbody>
                    @forelse($npiList as $idx => $npi)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($npi->_kasubbagApproval?->status === 'PENDING')
                                    <a href="{{ route('verifikasi-kasubag.npi.kontrak.show', $npi->id) }}" class="btn btn-sm btn-primary px-3">
                                        <i class="material-icons-outlined" style="font-size:14px; vertical-align: middle;">fact_check</i> Verifikasi
                                    </a>
                                @else
                                    <a href="{{ route('verifikasi-kasubag.npi.kontrak.show', $npi->id) }}" class="btn btn-sm btn-outline-secondary px-3">
