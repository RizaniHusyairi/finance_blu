@extends('layouts.app')
@section('title', 'Detail Verifikasi NPI Kontrak — Kasubbag')
        ...
        <div class="d-flex flex-column flex-xl-row justify-content-between gap-3">
            <div class="flex-grow-1">
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <span class="badge bg-primary px-2 py-1">Kontrak — Kasubbag</span>
                </div>
            ...
            <div class="d-flex flex-column gap-2" style="min-width: 200px;">
                ...
                <a href="{{ route('verifikasi-kasubag.npi.kontrak.index') }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    @forelse($revisionNotes as $note)
                        <div class="border-start border-3 {{ str_contains($note['role'], 'Subbagian') ? 'border-info' : (str_contains($note['role'], 'PPK') ? 'border-primary' : 'border-warning') }} ps-3 mb-3">
...
@if($canApprove)
    <div class="card border-0 shadow-sm mb-4 border-top border-4 border-warning">
        <div class="card-body p-4 text-center">
            ...
            <p class="text-muted mb-3">NPI ini menunggu tindakan verifikasi dari Anda sebagai Kasubbag.</p>
...
@elseif($kasubbagStatus === 'APPROVED')
    <div class="card border-0 shadow-sm mb-4 border-top border-4 border-success">
        <div class="card-body p-4 text-center">
            ...
            <p class="text-muted mb-0">Disetujui pada {{ $kasubbagApproval?->acted_at ? \Carbon\Carbon::parse($kasubbagApproval->acted_at)->format('d M Y H:i') : '-' }}</p>
...
@elseif(in_array($kasubbagStatus, ['REVISION', 'REJECTED']))
    <div class="card border-0 shadow-sm mb-4 border-top border-4 border-danger">
        <div class="card-body p-4 text-center">
            ...
            @if($kasubbagApproval?->catatan)
                <p class="text-muted fst-italic">"{{ $kasubbagApproval->catatan }}"</p>
            @endif
        </div>
    </div>
@endif
...
<div class="modal fade" id="modalApprove" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form action="{{ route('verifikasi-kasubag.npi.kontrak.approve', $npi->id) }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <p>Tindakan ini akan menyelesaikan verifikasi Kasubbag untuk dokumen <strong>{{ $npi->nomor_npi }}</strong>.</p>
                    <div class="alert alert-info border-0 py-2 small">
                        ...
                        Verifikasi dari Bendahara Penerimaan dan PPK berjalan secara paralel. Persetujuan Anda tidak tergantung pada mereka.
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modalRevisi" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form action="{{ route('verifikasi-kasubag.npi.kontrak.revisi', $npi->id) }}" method="POST">
                @csrf
