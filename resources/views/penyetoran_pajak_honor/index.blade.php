@extends('layouts.app')
@section('title', 'Penyetoran Pajak Honorarium')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <x-page-title title="Penyetoran Pajak Honorarium" subtitle="Kelola Kode Billing dan NTPN untuk PPh 21 honorarium yang sudah cair (SP2D EXECUTED)." />
    </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <a href="{{ route('pajak-potongan.honor.index', ['status' => 'belum_billing']) }}" class="summary-card">
        ...
        <div class="col-md-4">
            <a href="{{ route('pajak-potongan.honor.index', ['status' => 'sudah_billing']) }}" class="summary-card">
        ...
        <div class="col-md-4">
            <a href="{{ route('pajak-potongan.honor.index', ['status' => 'sudah_setor']) }}" class="summary-card">
    ...
    <div class="filter-bar">
        <form method="GET" action="{{ route('pajak-potongan.honor.index') }}" class="row g-2 align-items-end">
            <div class="col-md-4">
                <label class="form-label small fw-semibold mb-1">Cari</label>
                <input type="text" name="search" class="form-control form-control-sm" placeholder="Tagihan, personel, billing, NTPN..." value="{{ $search ?? '' }}">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('pajak-potongan.honor.index') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-pajak align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            <th>#</th>
                            <th>Tagihan Honorarium</th>
                            <th>Penerima</th>
                            <th>Jenis Pajak</th>
                            <th class="text-end">Nominal PPh 21</th>
                            <th>Kode Billing</th>
                            <th>NTPN</th>
                            <th>Status</th>
                    ...
                    <tbody>
                        @forelse($potonganList as $idx => $pot)
                            @php
                                $tagihan = $pot->tagihan;
                                $jumlahPenerima = $tagihan?->detailHonorarium?->count() ?? 0;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-muted small">{{ Str::limit($tagihan?->deskripsi, 40) }}</div>
                                </td>
                                <td><div class="fw-semibold small">{{ $jumlahPenerima }} orang</div></td>
                                <td>
                                    <div class="fw-semibold">PPh 21</div>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('pajak-potongan.honor.detail', $pot->id) }}" class="btn btn-sm btn-outline-primary">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-5">
                                    ...
                                    Belum ada potongan pajak honorarium yang siap diproses.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
