                        ...
                        <div class="mb-2">
                            ...
                            <select name="ppk_user_id" class="form-select select2" id="ppkUserId">
                                ...
                                @foreach($ppkUsers as $user)
                                    <option value="{{ $user->id }}" data-nip="{{ $user->nip }}" data-nama="{{ $user->name }}" {{ old('ppk_user_id') == $user->id ? 'selected' : '' }}>
                                        {{ $user->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select name="bendahara_pengeluaran_user_id" class="form-select select2" id="bendaharaUserId">
                                ...
                                @foreach($bendaharaUsers as $user)
                                    <option value="{{ $user->id }}" data-nip="{{ $user->nip }}" data-nama="{{ $user->name }}" {{ old('bendahara_pengeluaran_user_id') == $user->id ? 'selected' : '' }}>
                                        {{ $user->name }}
                                    </option>
                                @endforeach
                            </select>
