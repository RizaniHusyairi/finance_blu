...
@endpush
@section('content')
<x-page-title title="Verifikasi Tagihan Kontrak" subtitle="Daftar Pengajuan Tagihan Termin/BAST Kontrak" />
                            ...
                            @foreach($tagihansPerlu as $i => $tagihan)
                                ...
                                <tr class="doc-row">
                                    ...
                                    <td>
                                        ...
                                        @if($kontrak)
                                            <span class="badge bg-primary-subtle text-primary border border-primary-subtle small mt-1 font-monospace">
                                                {{ $kontrak->nomor_spk ?? '-' }}
                                            </span>
                                        @endif
                                    </td>
                                    <td class="fw-semibold text-success">Rp {{ number_format($tagihan->total_bruto, 0, ',', '.') }}</td>
                                    <td>
                        ...
                        <tbody>
                            @foreach($tagihansRiwayat as $i => $tagihan)
                                ...
                                <tr class="doc-row">
                                    ...
                                    <td class="fw-semibold">Rp {{ number_format($tagihan->total_bruto, 0, ',', '.') }}</td>
                                    <td>@include('verifikasi_perjaldin.partials.status-badge', ['status' => $tagihan->status])</td>
                                    <td class="text-center">
