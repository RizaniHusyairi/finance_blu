...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
            <h4 class="fw-bold mb-1">Verifikasi Tagihan Kontrak</h4>
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('verifikasi-tagihan-kontrak.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            @foreach($approvals as $a)
                                ...
                                <div class="approval-row {{ $meta['cls'] }}">
                                    ...
                                    <div class="flex-grow-1 min-width-0">
                                        <div class="fw-bold">{{ $a->nama_step }}</div>
                                        <div class="small text-muted">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-header bg-white border-bottom pt-4 px-4 pb-3">
                    <h5 class="fw-bold mb-0 text-info"><i class="bi bi-file-earmark-check me-2"></i>Detail Berita Acara</h5>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="text-muted small">BAPP</div>
                            <div class="fw-bold">{{ $tagihan->detailKontrak->nomor_bapp ?? '-' }}</div>
                            <div class="small text-muted">{{ optional($tagihan->detailKontrak->tanggal_bapp)->format('d M Y') ?? '-' }}</div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-muted small">BAST</div>
                            <div class="fw-bold">{{ $tagihan->detailKontrak->nomor_bast ?? '-' }}</div>
                            <div class="small text-muted">{{ optional($tagihan->detailKontrak->tanggal_bast)->format('d M Y') ?? '-' }}</div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-muted small">BAP</div>
                            <div class="fw-bold">{{ $tagihan->detailKontrak->nomor_bap ?? '-' }}</div>
                            <div class="small text-muted">{{ optional($tagihan->detailKontrak->tanggal_bap)->format('d M Y') ?? '-' }}</div>
                        </div>
                    </div>

                    <hr>
                    <div class="text-muted small fw-bold mb-2">Dokumen Berita Acara Final (TTD)</div>
            ...
            {{-- Dokumen Kontrak Induk: SPK / SPMK / Ringkasan Kontrak --}}
            @php
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-header bg-white border-bottom pt-4 px-4 pb-3">
                    <h5 class="fw-bold mb-0 text-primary"><i class="bi bi-file-earmark-pdf me-2"></i>Dokumen Kontrak Induk</h5>
