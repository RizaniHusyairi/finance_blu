...
@endsection
@section('content')
    <x-page-title title="Master Data" subtitle="Edit Mitra" />

    <div class="card">
        <div class="card-body">
            <h5 class="mb-4">Form Edit Mitra</h5>
            <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="type" name="type" value="{{ old('type', $supplier->type) }}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="bank_account" name="bank_account" value="{{ old('bank_account', $supplier->bank_account) }}">
                    </div>
                </div>
                <div class="row mb-3">
