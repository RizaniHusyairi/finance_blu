@extends('layouts.app')
@section('title', 'Detail Buku Pengesahan Pendapatan')

@include('pembukuan.partials.styles')

@section('content')
    <x-page-title title="Pembukuan" subtitle="Detail Buku Pengesahan Pendapatan" />
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('pembukuan.pengesahan-pendapatan.index') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
    </div>
    ...
    <div class="book-meta mb-4">
        ...
        <div class="book-meta-item">
            <div class="meta-label">Total Penerimaan</div>
            <div class="meta-value">Rp {{ number_format($report->total_penerimaan, 0, ',', '.') }}</div>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-xl-7">
            <div class="card book-card mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4"><strong>Total Penerimaan</strong><div class="fw-bold text-success">Rp {{ number_format($report->total_penerimaan, 0, ',', '.') }}</div></div>
            ...
            <div class="card book-card mb-4">
                <div class="card-header"><h6 class="mb-0 fw-bold">Ringkasan Sumber Data Penerimaan</h6></div>
                <div class="card-body">
                    ...
                    <div class="small text-muted mt-2">
                        Pembanding kontrol sisi penerimaan: BKU masuk, transaksi penerimaan (invoice), dan mutasi bank masuk pada periode yang sama.
                    </div>
                </div>
            </div>
