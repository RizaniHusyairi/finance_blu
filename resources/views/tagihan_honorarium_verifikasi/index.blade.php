...
<div class="page-header-container d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 animate-fade-in-up">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h3 class="fw-bold mb-1 text-dark page-title-gradient" style="font-size: 1.55rem; letter-spacing: -0.02em;">Verifikasi Tagihan Honorarium</h3>
            <div class="d-flex align-items-center gap-2 text-muted small">
                <a href="javascript:;" class="text-secondary text-decoration-none"><i class="bi bi-house-door"></i></a>
                <span class="opacity-50">/</span>
                <span class="text-secondary fw-medium">Daftar Pengajuan Honorarium yang Menunggu / Sudah Anda Verifikasi</span>
            </div>
        </div>
    </div>
</div>
                    ...
                    <table class="table modern-table table-hover align-middle mb-0" id="tablePerlu">
                        <thead>
                            <tr>
                                ...
                                <th><i class="bi bi-building"></i>Supplier & Penerima</th>
                                <th><i class="bi bi-wallet2"></i>Total Netto</th>
                                    ...
                                    <td>
                                        ...
                                        @if($tagihan->mekanisme_pembayaran)
                                            <span class="badge bg-primary small mt-1">
                                                <i class="bi bi-credit-card me-1"></i>{{ optional($tagihan->mekanisme_pembayaran)->label() ?? '-' }}
                                            </span>
                                        @endif
                                    </td>
                                    <td class="rp-nominal text-success">Rp {{ number_format($tagihan->total_netto, 0, ',', '.') }}</td>
                                    <td>
                        ...
                        <tbody>
                            @foreach($tagihansRiwayat as $i => $tagihan)
                                <tr class="doc-row">
                                    ...
                                    <td class="rp-nominal">Rp {{ number_format($tagihan->total_netto, 0, ',', '.') }}</td>
                                    <td>@include('verifikasi_perjaldin.partials.status-badge', ['status' => $tagihan->status])</td>
                                    <td class="text-center">
