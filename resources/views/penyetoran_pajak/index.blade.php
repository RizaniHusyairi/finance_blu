@extends('layouts.app')
@section('title', 'Penyetoran Pajak')

@push('css')
<style>
    .pajak-hero { background: linear-gradient(135deg, #f8f9ff, #eef2ff); border-bottom: 1px solid rgba(15,23,42,.08); padding: 1.5rem; margin-bottom: 1.5rem; position: relative; border-radius: .75rem; }
    .pajak-hero::before { content: ""; position: absolute; left: 0; top: 0; width: 4px; height: 100%; background: #6366f1; border-radius: .75rem 0 0 .75rem; }
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <x-page-title title="Penyetoran Pajak" subtitle="Kelola Kode Billing dan NTPN dari potongan pajak tagihan yang sudah final." />
    </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <a href="{{ route('pajak-potongan.index', ['status' => 'belum_billing']) }}" class="summary-card">
        ...
        <div class="col-md-4">
            <a href="{{ route('pajak-potongan.index', ['status' => 'sudah_billing']) }}" class="summary-card">
        ...
        <div class="col-md-4">
            <a href="{{ route('pajak-potongan.index', ['status' => 'sudah_setor']) }}" class="summary-card">
    ...
    <div class="filter-bar">
        <form method="GET" action="{{ route('pajak-potongan.index') }}" class="row g-2 align-items-end">
            <div class="col-md-4">
                <label class="form-label small fw-semibold mb-1">Cari</label>
                <input type="text" name="search" class="form-control form-control-sm" placeholder="Nomor tagihan, billing, NTPN..." value="{{ $search ?? '' }}">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('pajak-potongan.index') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
                        ...
                        @forelse($potonganList as $idx => $pot)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-muted small text-truncate" style="max-width: 220px;">{{ Str::limit($tagihan?->deskripsi, 50) }}</div>
                                </td>
                                <td><span class="badge bg-light text-dark border">{{ $tagihan?->tipe_tagihan ?? '-' }}</span></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('pajak-potongan.detail', $pot->id) }}" class="btn btn-sm btn-outline-primary">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-5">
                                    ...
                                    Belum ada potongan pajak yang siap diproses.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
