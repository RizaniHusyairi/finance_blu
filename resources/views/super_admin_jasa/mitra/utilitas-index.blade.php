                        ...
                        <td class="pe-3 text-end">
                            ...
                            @if($lap->status == 'dikirim_ke_admin_jasa')
                                @if($canCreateTagihanJasa)
                                    <a href="{{ route('tagihan-jasa.create', ['utilitas_id' => $lap->id]) }}" class="btn btn-sm btn-primary fw-semibold" title="Buat tagihan" aria-label="Buat tagihan">
                            ...
                            @elseif($lap->status == 'ditagihkan' && $lap->tagihan_jasa_id)
                                <a href="{{ route('tagihan-jasa.show', $lap->tagihan_jasa_id) }}" class="btn btn-sm btn-light border text-primary fw-semibold" title="Lihat tagihan" aria-label="Lihat tagihan">
                                    <i class="bi bi-receipt me-1"></i>Tagihan
                                </a>
                            @endif
                        </td>
