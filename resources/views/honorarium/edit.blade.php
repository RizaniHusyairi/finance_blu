...
@section('content')
    <x-page-title title="Manajemen Honor" subtitle="Edit Honorarium" />

    {{-- Header --}}
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div>
            <h6 class="mb-1 text-uppercase fw-bold"><i class="bi bi-pencil-square me-1"></i> Edit Honorarium — <span class="text-primary">{{ $tagihan->nomor_tagihan }}</span></h6>
            <p class="text-muted small mb-0">Perbarui data kegiatan, penerima, dan komponen pembayaran.</p>
        </div>
    ...
    <form action="{{ route('honorarium.update', $tagihan->id) }}" method="POST" enctype="multipart/form-data" id="honorariumForm">
        @csrf
        @method('PUT')
        <div class="row">
            {{-- LEFT COLUMN --}}
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="deskripsi" id="inp_deskripsi" class="form-control" required
                                    value="{{ old('deskripsi', $tagihan->deskripsi) }}" placeholder="Contoh: Pembayaran Honor Narasumber Sosialisasi...">
                            </div>
                        </div>
