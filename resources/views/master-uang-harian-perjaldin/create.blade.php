...
@section('content')
    ...
    <div class="page-header-container">
        <div class="page-title-wrapper animate-fade-in-up delay-1">
            <h5 class="page-title-badge">Tambah Uang Harian</h5>
            <span class="page-subtitle">Isi detail besaran uang harian untuk daerah/provinsi baru</span>
        </div>
    ...
    <div class="page-card delay-2">
        <div class="form-section-title animate-fade-in-up delay-1">
            <i class="bi bi-folder-plus"></i> Form Pengisian Uang Harian
        </div>
