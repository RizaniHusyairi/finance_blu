...
<head>
    ...
    <style>
        ...
        footer {
    position: fixed;
    bottom: 0; /* jangan minus biar nggak aneh di PDF */
    left: 0;
    right: 0;
...
<body>
        ...
        <tr>
            <td>
                ...
                @if(!empty($tteQrFilePath))
                    <img src="{{ $tteQrFilePath }}" alt="QR TTE SPK" class="qr-tte">
    ...
    <div style="border: 1px solid black; padding: 15px 20px; font-family: 'Footlight MT Light', serif; margin-bottom: 40px; background-color: #fff;">
