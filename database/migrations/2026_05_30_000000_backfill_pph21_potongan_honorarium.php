...
/**
 * Backfill baris potongan_tagihan PPh 21 untuk tagihan HONORARIUM lama yang
 * disimpan sebelum SppController::storeHonor membentuk potongan pajak otomatis.
 *
 * Tanpa baris ini, tagihan honor tidak muncul di menu Penyetoran Pajak meski
 * detail_honorarium.pph > 0. Migration ini hanya membuat baris yang belum ada.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! $pajak) {
            // Tidak ada tarif PPh 21 aktif; lewati backfill.
            return;
        }
